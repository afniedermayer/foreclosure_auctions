...
have chosen countermeasures to avoid adverse selection. First,
...
In particular, we can use information on whether a foreclosed mortgage was securitized or not. If securitization leads to moral hazard, we should expect the bank to have no (or only a minor) informational advantage over third-party bidders for case of securitized mortgages. This means essentially an independent private value auction. For non-securitized mortgages we should expect the bank to have an informational advantage. This means an auction with a common value component on the bank's side.
